...
from models.dbModel_Itemlog import init_db, get_programs, get_attendees, get_items
...
def get_items_log():
    ...
    return items
    #return templates.TemplateResponse("index2d.html", {"request": request, "items": items})
