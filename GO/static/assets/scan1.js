    ...
    //<!-- EVENT SUBMIT BUTTON - SAVE SCANNED INPUT TO LOCALSTORAGE -->
        ...
        const serverURL = 'http://192.168.1.3:8856';
        ...
        function sendDataToServer(newSubmission, endpoint, serverURL) {
            ...
            checkServerStatus(serverURL)
                .then(isOnline => {
                    if (isOnline) {
                        ...
                        console.log('Cannot send data because server is offline');
                    }
                });
        }
        ...
        function handleFormSubmission() {
            ...
            */
            ...
            let inputString = input2Val.toString();
            ...
            sendDataToServer(newSubmission11, endpoint, serverURL);
            sendDataToServer(newSubmission22, endpoint, serverURL);
            sendDataToServer(newSubmission33, endpoint, serverURL);
    ...
    //<!-- SCANNER SCRIPT -->
        ...
        function openScanner(inputId) {
            ...
            // Show the "Cancel Scanning" button
            const cancelScanButton = document.getElementById('CancelScan');
            cancelScanButton.style.display = 'block';
            ...
            // Add event listener to cancel button to close the scanner
            cancelScanButton.addEventListener('click', closeScanner);
        }
