    ...
    //<!-- EVENT SUBMIT BUTTON - SAVE SCANNED INPUT TO LOCALSTORAGE -->
        ...
        function handleFormSubmission() {
            if (document.getElementById('scaninput4').value === '') document.getElementById('scaninput4').value = 'na';
            ...
            // Get the values of the "Keyboard" and "Mouse" checkboxes
            const keyboardCheckbox = document.getElementById('keyboardCheckbox');
            const mouseCheckbox = document.getElementById('mouseCheckbox');
            
            // Check if the checkboxes are checked and set values accordingly
            const keyboardVal = keyboardCheckbox.checked ? 'Yes' : 'No';
            const mouseVal = mouseCheckbox.checked ? 'Yes' : 'No';
            ...
            // Append keyboard and mouse values to formData
            formData.append('keyboard', keyboardVal);
            formData.append('mouse', mouseVal);
    ...
    //<!-- SCANNER SCRIPT -->
        ...
        addClickListenerToScanInput(scaninput4Var, 4);
